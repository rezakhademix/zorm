...
type schema struct {
	...
	setPK             func(o Entity, value any)
	getPK             func(o Entity) any
...
func valuesOfField(vf reflect.Value) []any {
	var values []any
...
func genericValuesOf(o Entity, withPK bool) []any {
	t := reflect.TypeOf(o)
	v := reflect.ValueOf(o)
...
func genericSetPkValue(obj Entity, value any) {
	genericSet(obj, getSchemaFor(obj).pkName(), value)
}

func genericGetPKValue(obj Entity) any {
	t := reflect.TypeOf(obj)
...
func pointersOf(v reflect.Value) map[string]any {
	m := map[string]any{}
	actualV := v
...
func genericSet(obj Entity, name string, value any) {
